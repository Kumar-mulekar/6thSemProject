...
public class UpdateInformation extends JFrame implements ActionListener {
    ...
    private boolean validateCustomer() {
        boolean flag2 = true, flag3 = true, flag4 = true;
        ...
        try {
            ...
            mat = pat1.matcher(t5.getText());
            if (mat.matches() && t5.getText().length() == 10) {
                flag4 = true;
            } else {
